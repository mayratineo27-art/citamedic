...
**User Story:** Como Paciente registrado en el padrón de la posta, quiero activar mi cuenta o recuperar mi contraseña usando mis datos personales, para acceder al sistema sin depender de email ni SMS.
...
**User Story:** Como usuario del sistema (Paciente, Admisión o Administrador), quiero ingresar mis credenciales, para acceder a las funciones correspondientes a mi rol.
...
**User Story:** Como usuario autenticado, quiero cerrar mi sesión, para proteger mi cuenta al terminar de usar el sistema.
...
**User Story:** Como Paciente, quiero actualizar mi número de celular y contraseña desde mi perfil, para mantener mis datos de contacto vigentes.
...
**User Story:** Como personal de Admisión, quiero resetear la contraseña de un Paciente desde ventanilla, para asistir a pacientes que no pueden recuperar acceso por sí mismos.
...
**User Story:** Como Paciente, quiero consultar mi perfil, para verificar mis datos personales registrados en el sistema.
...
**User Story:** Como Tutor, quiero cambiar mi sesión al perfil de un Dependiente registrado, para gestionar sus citas sin necesidad de credenciales separadas.
...
**User Story:** Como Paciente, quiero consultar las especialidades disponibles, para iniciar el proceso de reserva de cita.
...
**User Story:** Como Paciente, quiero consultar los turnos y horarios disponibles para una especialidad, para elegir el slot que mejor se adapte a mi disponibilidad.
...
**User Story:** Como Paciente, quiero reservar una cita médica siguiendo un flujo guiado, para asegurar mi atención en la especialidad y horario elegidos.
...
**User Story:** Como personal de Admisión, quiero registrar citas de pacientes que se presentan en ventanilla, para integrar la atención presencial al mismo stock de cupos que la reserva web.
...
**User Story:** Como Paciente, quiero cancelar una cita activa dentro del horario permitido, para liberar el cupo y permitir que otro paciente lo use.
...
**User Story:** Como personal de Admisión, quiero cancelar cualquier cita activa sin restricción horaria, para gestionar situaciones operativas que el Paciente no puede resolver por sí mismo.
...
**User Story:** Como sistema, quiero generar un ticket automáticamente al confirmar cualquier reserva, para garantizar que el Paciente tenga un comprobante formal de su cita.
...
**User Story:** Como Paciente, quiero consultar el estado actual de mis citas, para hacer seguimiento a mi atención médica.
...
**User Story:** Como Administrador, quiero gestionar las Unidades Prestadoras de Servicios, para estructurar la oferta de servicios de la posta.
...
**User Story:** Como Administrador, quiero configurar las especialidades médicas, para definir los servicios disponibles para los pacientes.
...
**User Story:** Como Administrador, quiero configurar la programación operativa futura, para establecer la oferta base de turnos médicos.
...
**User Story:** Como personal de Admisión, quiero habilitar la disponibilidad configurada por el Administrador, para abrir los cupos al público web y presencial antes de la jornada.
...
**User Story:** Como personal de Admisión, quiero ajustar los cupos de programaciones futuras, para reflejar cambios operativos como rotaciones o ausencias de médicos.
...
**User Story:** Como Administrador, quiero gestionar el catálogo de médicos, para asignarlos a las programaciones operativas.
...
**User Story:** Como Administrador, quiero gestionar las cuentas de usuarios internos (Admisión y Administrador), para controlar el acceso operativo al sistema.
...
**User Story:** Como Administrador, quiero gestionar los vínculos entre tutores y dependientes, para mantener el padrón de relaciones familiares actualizado.
...
**User Story:** Como personal de Admisión, quiero registrar vínculos tutor-dependiente desde ventanilla, para asistir a familias que se presentan presencialmente.
...
**User Story:** Como personal de Admisión, quiero ver todas las citas del día con filtro por DNI, para gestionar la agenda global de la posta y resolver conflictos diarios.
...
**User Story:** Como personal de Admisión, quiero buscar el número de historia clínica de un paciente ingresando su DNI, para localizar físicamente el expediente en el archivo.
...
**User Story:** Como personal de Admisión, quiero disponer de un buscador rápido en el panel principal, para encontrar pacientes por DNI sin navegar por menús.
